...
const TECH_STACK = ["MERN", "NextJS", "Python", "C++"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Nasirulla786" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/nasirulla/" },
  { icon: Instagram, link: "https://www.instagram.com/code_with_razz?igsh=MXEyaGpsNnM3ZTZraw==" },
];
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#030014] overflow-hidden p-10" id="Home">
      <div
